 ...
 *   npx hardhat verify --network monad --contract contracts/BossFightGame.sol:BossFightGame 0xc7a4F99Dad829Dc9D8FD77D5bbb4C1387B908E79
 */
async function main() {
  // Contract address - can be overridden with CONTRACT_ADDRESS env var
  const contractAddress = process.env.CONTRACT_ADDRESS || "0xc7a4F99Dad829Dc9D8FD77D5bbb4C1387B908E79";
